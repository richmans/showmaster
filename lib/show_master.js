...
ShowMaster.prototype.load = function(name) {
  var outputFilename = __dirname + "/../programs/" + name + ".json";
  try {
    json = JSON.parse(require('fs').readFileSync(outputFilename, 'utf8'));
  } catch (err) {
...
ShowMaster.prototype.loadDevice = function(id, deviceType, attributes) {
